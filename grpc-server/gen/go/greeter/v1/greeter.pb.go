...
func (x *SayHelloRequest) GetLang() string {
	if x != nil {
		return x.Lang
	}
	return ""
...
const file_greeter_v1_greeter_proto_rawDesc = "" +
	...
	"\x05count\x18\x02 \x01(\x05R\x05count2W\n" +
	"\x0eGreeterService\x12E\n" +
	"\bSayHello\x12\x1b.greeter.v1.SayHelloRequest\x1a\x1c.greeter.v1.SayHelloResponseB)Z'grpc-server/gen/go/greeter/v1;greeterv1b\x06proto3"
